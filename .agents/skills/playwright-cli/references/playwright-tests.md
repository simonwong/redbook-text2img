...
To run Playwright tests, use `pnpm exec playwright test` or a package script. To avoid opening the interactive HTML report, set the `PLAYWRIGHT_HTML_OPEN=never` environment variable.
