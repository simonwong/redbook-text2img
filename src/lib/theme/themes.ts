  ...
  // ===== 渐变系列 =====
  {
    ...
    style: {
      background: {
        type: "gradient",
        value:
          "linear-gradient(135deg, #fff7ed 0%, #fef3c7 30%, #fed7aa 60%, #fbbf24 100%)",
      },
      typography: baseTypography,
...

  {
    ...
    style: {
      background: {
        type: "gradient",
        value:
          "linear-gradient(140deg, #f0f9ff 0%, #dbeafe 30%, #93c5fd 65%, #60a5fa 100%)",
      },
      typography: baseTypography,
  ...
  },
  {
    ...
    style: {
      background: {
        type: "gradient",
        value:
          "linear-gradient(135deg, #fdf2f8 0%, #fce7f3 25%, #f9a8d4 65%, #f472b6 100%)",
      },
      typography: baseTypography,
