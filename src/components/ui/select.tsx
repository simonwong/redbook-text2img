  ...
  return (
    ...
    >
      ...
      <SelectPrimitive.Icon asChild>
        <HugeiconsIcon className="size-4 opacity-50" icon={ChevronDown} />
...
function SelectScrollUpButton({
  ...
  return (
    <SelectPrimitive.ScrollUpButton
      ...
      {...props}
    >
      <HugeiconsIcon className="size-4" icon={ChevronUp} />
    </SelectPrimitive.ScrollUpButton>
  );
}
...
function SelectScrollDownButton({
  ...
  return (
    <SelectPrimitive.ScrollDownButton
      ...
      {...props}
    >
      <HugeiconsIcon className="size-4" icon={ChevronDown} />
    </SelectPrimitive.ScrollDownButton>
  );
}
